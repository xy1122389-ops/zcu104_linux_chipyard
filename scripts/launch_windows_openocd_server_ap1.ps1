param(
  ...
  [string]$Cfg = "\\wsl.localhost\Ubuntu-22.04\root\chipyard\fpga\scripts\openocd_zcu104_win_custom_serial_1000_server_ap1.cfg",
  [string]$OutDir = "$env:TEMP\openocd_server_ap1"
)
