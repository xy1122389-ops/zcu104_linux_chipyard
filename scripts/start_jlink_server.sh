...
primary_args="-select USB=$JLINK_SERIAL -device RISC-V -endian little -if JTAG -speed 1000 -JTAGConf 0,0 -port 3333 -LocalhostOnly 0 -noir -noreset -noexit"
fallback_args="-select USB=$JLINK_SERIAL -device RISC-V -endian little -if JTAG -speed 1000 -JTAGConf 0,0 -port 3333 -LocalhostOnly 0 -noreset -noexit"
