...
module Queue1_RegMapperInput_i9_m8(	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][28:0]};	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_extra_tlrr_extra_source = ram[89:82];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  assign io_deq_bits_extra_tlrr_extra_size = ram[91:90];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
