...
module Queue2_TLBundleD_a32d64s1k3z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x78 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_denied, io_enq_bits_sink, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[11:9];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
