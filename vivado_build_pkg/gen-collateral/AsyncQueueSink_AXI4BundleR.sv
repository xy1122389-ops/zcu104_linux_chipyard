...
module AsyncQueueSink_AXI4BundleR(	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7]
  ...
  wire [136:0]      _io_deq_bits_deq_bits_reg_io_q;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
  ...
  wire [7:0][127:0] _GEN_0 = {{io_async_mem_7_data}, {io_async_mem_6_data}, {io_async_mem_5_data}, {io_async_mem_4_data}, {io_async_mem_3_data}, {io_async_mem_2_data}, {io_async_mem_1_data}, {io_async_mem_0_data}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  wire [7:0][1:0]   _GEN_1 = {{io_async_mem_7_resp}, {io_async_mem_6_resp}, {io_async_mem_5_resp}, {io_async_mem_4_resp}, {io_async_mem_3_resp}, {io_async_mem_2_resp}, {io_async_mem_1_resp}, {io_async_mem_0_resp}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  wire [7:0]        _GEN_2 = {{io_async_mem_7_last}, {io_async_mem_6_last}, {io_async_mem_5_last}, {io_async_mem_4_last}, {io_async_mem_3_last}, {io_async_mem_2_last}, {io_async_mem_1_last}, {io_async_mem_0_last}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  ...
  ClockCrossingReg_w137 io_deq_bits_deq_bits_reg (	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  ({_GEN[index], _GEN_0[index], _GEN_1[index], _GEN_2[index]}),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:156:55, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_id = _io_deq_bits_deq_bits_reg_io_q[136:131];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_data = _io_deq_bits_deq_bits_reg_io_q[130:3];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_resp = _io_deq_bits_deq_bits_reg_io_q[2:1];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25, :211:26]
