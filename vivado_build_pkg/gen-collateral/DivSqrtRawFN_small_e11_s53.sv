...
module DivSqrtRawFN_small_e11_s53(	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
  ...
  wire [52:0] _fractB_Z_T_4 = inReady & ~io_sqrtOp ? {io_b_sig[51:0], 1'h0} : 53'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :271:33, :342:{16,25,73,90}]
  ...
  wire [55:0] rem = {1'h0, inReady & ~oddSqrt_S ? {io_a_sig, 1'h0} : 55'h0} | (_sigX_Z_T_7 ? {io_a_sig[52:51] - 2'h1, io_a_sig[50:0], 3'h0} : 56'h0) | (inReady ? 56'h0 : {rem_Z, 1'h0});	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5, :225:33, :243:29, :292:32, :352:{12,21,24,47,57}, :353:{12,21}, :354:{16,27,56}, :355:27, :358:11, :359:{12,29}]
  wire [54:0] _trialTerm_T_3 = inReady & ~io_sqrtOp ? {io_b_sig, 1'h0} : 55'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :271:33, :362:{12,21,48}]
  wire [54:0] _trialTerm_T_9 = {_trialTerm_T_3[54], _trialTerm_T_3[53:0] | {inReady & io_sqrtOp & ~(io_a_sExp[0]), 53'h0}} | (_sigX_Z_T_7 ? 55'h50000000000000 : 55'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :291:{32,35,48}, :353:21, :362:{12,74}, :363:{12,21,74}, :364:12]
  wire [57:0] trialRem = {2'h0, rem} - {2'h0, {1'h0, _trialTerm_T_9[54], _trialTerm_T_9[53] | ~inReady & ~sqrtOp_Z, _trialTerm_T_9[52:0] | (inReady ? 53'h0 : fractB_Z)} | (~inReady & sqrtOp_Z ? {sigX_Z, 1'h0} : 56'h0)};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :228:29, :236:29, :245:29, :340:23, :352:57, :358:11, :363:74, :364:74, :365:{12,74}, :366:{23,26,74}, :367:{12,23,44}, :368:29]
  ...
  wire [54:0] _sigX_Z_T_3 = inReady & ~io_sqrtOp ? {newBit, 54'h0} : 55'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :271:33, :369:23, :394:{16,25,50}]
  wire [53:0] _GEN_0 = _sigX_Z_T_3[53:0] | {inReady & io_sqrtOp, 53'h0};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :394:{16,74}, :395:{16,25}]
  always @(posedge clock) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
    if (reset) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
      ...
      cycleNum <= {_cycleNum_T_15[5:1], _cycleNum_T_15[0] | skipCycle2};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :301:39, :305:57, :312:15, :313:95]
      inReady <= entering & ~normalCase_S | ~entering & ~skipCycle2 & cycleNum - 6'h1 < 6'h2 | skipCycle2;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :225:33, :277:27, :297:28, :301:39, :305:{26,28}, :312:15, :313:{16,17,28,31,56,95}, :317:38]
      rawOutValid <= entering & ~normalCase_S | ~entering & ~skipCycle2 & cycleNum - 6'h1 == 6'h1 | skipCycle2;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :226:33, :277:27, :297:28, :301:39, :305:{26,28}, :312:15, :313:{16,17,28,31,56,95}, :318:42]
    end
    ...
    if (_GEN) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:390:20]
      rem_Z <= newBit ? trialRem[54:0] : rem[54:0];	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:243:29, :352:57, :358:11, :368:29, :369:23, :371:24]
      sigX_Z <= {_sigX_Z_T_3[54], _GEN_0[53], _GEN_0[52:0] | (_sigX_Z_T_7 ? {newBit, 52'h0} : 53'h0)} | (inReady ? 55'h0 : sigX_Z) | (~inReady & newBit ? _bitMask_T[56:2] : 55'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :245:29, :340:23, :353:21, :360:{23,34}, :369:23, :394:{16,74}, :395:74, :396:{16,50,74}, :397:{16,74}, :398:{16,27}]
    end
