...
rd 0x1000
catch {mwr 0x1000 0x80000000} wr0
puts "mwr 0x1000 0x80000000 => $wr0"
rd 0x1000
catch {mwr 0x1004 0x00000000} wr1
puts "mwr 0x1004 0x00000000 => $wr1"
rd 0x1004
show_targets "after bootaddr psu test"
