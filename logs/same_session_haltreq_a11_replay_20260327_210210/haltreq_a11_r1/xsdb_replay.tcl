...
if {$preclear} {set _dummy 0}
if {$preclear} {$seq drshift -capture -integer 53 0x653}
if {$preclear} {puts "WRITE_RESUMEREQ=[$seq run -hex]"}
if {$preclear} {
set seq [jtag sequence]
$seq irshift -integer 12 0x926
}
if {$preclear} {$seq drshift -capture -integer 53 0x53}
if {$preclear} {puts "PRECLEAR_NOP1=[$seq run -hex]"}
if {$preclear} {
set seq [jtag sequence]
$seq irshift -integer 12 0x926
}
if {$preclear} {$seq drshift -capture -integer 53 0x53}
if {$preclear} {puts "PRECLEAR_NOP2=[$seq run -hex]"}
if {$preclear} {
set seq [jtag sequence]
$seq irshift -integer 12 0x926
}
if {$preclear} {$seq drshift -capture -integer 53 0x653}
if {$preclear} {puts "WRITE_DMACTIVE=[$seq run -hex]"}
if {$preclear} {
set seq [jtag sequence]
$seq irshift -integer 12 0x926
}
if {$preclear} {$seq drshift -capture -integer 53 0x53}
if {$preclear} {puts "PRECLEAR_NOP3=[$seq run -hex]"}
if {$preclear} {
set seq [jtag sequence]
$seq irshift -integer 12 0x926
}
if {$preclear} {$seq drshift -capture -integer 53 0x53}
if {$preclear} {puts "PRECLEAR_NOP4=[$seq run -hex]"}
set seq [jtag sequence]
$seq irshift -integer 12 0x926
