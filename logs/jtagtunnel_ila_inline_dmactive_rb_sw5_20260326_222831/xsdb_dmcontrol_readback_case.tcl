...
puts "READ_DMCONTROL_dmactive=[$seq run -hex]"
set seq [jtag sequence]
$seq irshift -integer 12 0x926
$seq drshift -capture -integer 53 0x53
puts "NOPR10_1_dmactive=[$seq run -hex]"
set seq [jtag sequence]
$seq irshift -integer 12 0x926
$seq drshift -capture -integer 53 0x53
puts "NOPR10_2_dmactive=[$seq run -hex]"
set seq [jtag sequence]
$seq irshift -integer 12 0x926
...
$seq irshift -integer 12 0x926
$seq drshift -capture -integer 53 0x53
puts "NOPR11_1_dmactive=[$seq run -hex]"
set seq [jtag sequence]
$seq irshift -integer 12 0x926
$seq drshift -capture -integer 53 0x53
puts "NOPR11_2_dmactive=[$seq run -hex]"
exit
