...
relay_port = int(os.environ.get("JLINK_PORT", "2331"))
...
python
import gdb, os
dtb_default = "/root/chipyard/fpga/linux-bringup/demo-assets/dtb/generated/chipyard-zcu104-nol2-minimal.dtb"
...
gdb.write(f"\n=== Phase 3: Launch kernel (run {KERNEL_RUN_SECS}s then dump klog) ===\n")
gdb.execute("delete breakpoints")
