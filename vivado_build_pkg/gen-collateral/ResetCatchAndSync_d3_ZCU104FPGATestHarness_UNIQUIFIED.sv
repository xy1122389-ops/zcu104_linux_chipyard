...
module ResetCatchAndSync_d3_ZCU104FPGATestHarness_UNIQUIFIED(	// @[generators/rocket-chip/src/main/scala/util/ResetCatchAndSync.scala:13:7]
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_ZCU104FPGATestHarness_UNIQUIFIED io_sync_reset_chain(	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (1'h1),
