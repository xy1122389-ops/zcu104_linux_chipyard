...
rd 0x2000000
catch {mwr 0x2000000 0x00000001} wr
puts "mwr 0x2000000 0x00000001 => $wr"
rd 0x2000000
catch {mwr 0x2000000 0x00000000} wr2
puts "mwr 0x2000000 0x00000000 => $wr2"
rd 0x2000000
show_targets "after clint psu test"
