...
module ClockCrossingReg_w137(	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
  input          clock,	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
  input  [136:0] io_d,	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:195:14]
  output [136:0] io_q,	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:195:14]
  input          io_en	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:195:14]
);

  reg [136:0] cdc_reg;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:201:76]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
        ...
        cdc_reg = {_RANDOM[3'h0], _RANDOM[3'h1], _RANDOM[3'h2], _RANDOM[3'h3], _RANDOM[3'h4][8:0]};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7, :201:76]
      `endif // RANDOMIZE_REG_INIT
    end // initial
