...
module ClockCrossingReg_w145(	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
  input          clock,	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
  input  [144:0] io_d,	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:195:14]
  output [144:0] io_q,	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:195:14]
  input          io_en	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:195:14]
);

  reg [144:0] cdc_reg;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:201:76]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
    ...
    logic [31:0] _RANDOM[0:4];	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
        end	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7]
        cdc_reg = {_RANDOM[3'h0], _RANDOM[3'h1], _RANDOM[3'h2], _RANDOM[3'h3], _RANDOM[3'h4][16:0]};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:191:7, :201:76]
      `endif // RANDOMIZE_REG_INIT
    end // initial
