...
targets -set -nocase -filter {name =~ "*PSU*"}
show_targets "selected psu before clock/reset pulse"
...
rd 0x100000
catch {mwr 0x110000 0x00000001} tr1
puts "mwr 0x110000 0x00000001 => $tr1"
rd 0x110000
after 100
catch {mwr 0x110000 0x00000000} tr0
puts "mwr 0x110000 0x00000000 => $tr0"
rd 0x110000
catch {mwr 0x2000000 0x00000000} cl1
puts "clear msip again => $cl1"
rd 0x2000000
...
show_targets "after hart liveness probe v4"
disconnect
exit
