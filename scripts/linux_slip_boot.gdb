...
if die_catch:
    ...
    try:
        ...
        gdb.write("[fix] UART0 IE at 0x64000010 cleared via J-Link WriteU32\n")
        # UART1 base=0x64003000, IE offset=0x10
        gdb.execute("monitor WriteU32 0x64003010 0")
        gdb.write("[fix] UART1 IE at 0x64003010 cleared via J-Link WriteU32\n")
    except Exception as e:
