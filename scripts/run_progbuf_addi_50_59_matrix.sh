...
OUTDIR="$FPGA_DIR/logs/progbuf_addi_50_59_matrix_$STAMP"
mkdir -p "$OUTDIR"
...
for imm in 50 51 53 54 55 56 57 58 59; do
  run_one "$imm"
done
...
BASE63="/root/chipyard/fpga/logs/jtagtunnel_ila_inline_addi_x0_63_highprobe_20260327_121129/jtagtunnel_ila.csv"
...
while read -r label csv; do
  for base_name in ADDI_1 ADDI_20 ADDI_23 ADDI_63; do
    case "$base_name" in
      ADDI_1) base="$BASE1" ;;
      ADDI_20) base="$BASE20" ;;
      ADDI_23) base="$BASE23" ;;
